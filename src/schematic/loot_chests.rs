        ...
        let loot_table = match chest_type {
            LootChestType::Common => LootTable {
                drops: vec![
                    ...
                    Loot::new(WorldObject::StoneChunk, 1, 4, 0.25),
            ...
            LootChestType::Uncommon => LootTable {
                drops: vec![
                    ...
                    Loot::new(WorldObject::UpgradeTome, 1, 2, 1.),
            ...
            LootChestType::Rare => LootTable {
                drops: vec![
                    ...
                    Loot::new(WorldObject::IceStaff, 1, 1, 0.06),
                    ...
                    Loot::new(WorldObject::UpgradeTome, 2, 4, 1.),
                    Loot::new(WorldObject::OrbOfTransformation, 1, 2, 1.),
                ],
            },
