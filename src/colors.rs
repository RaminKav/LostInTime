...
pub const BLACK: Color = Color::rgba(15. / 255., 44. / 255., 46. / 255., 1.);
pub const NIGHT: Color = Color::rgba(15. / 255., 44. / 255., 46. / 255., 0.55);
pub const BLUE: Color = Color::rgba(61. / 255., 112. / 255., 133. / 255., 1.);
pub const YELLOW: Color = Color::rgba(225. / 255., 197. / 255., 132. / 255., 1.);
